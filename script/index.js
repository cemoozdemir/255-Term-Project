...
(function ($) {
  ...
  $.fn.dform = function (options, converter, error) {
    ...
    if ($.dform.methods[options]) {
      $.dform.methods[options].apply(
        self,
        Array.prototype.slice.call(arguments, 1)
      );
    } else {
      if (typeof options === "string") {
        $.dform.methods.ajax.call(
          self,
          {
            url: options,
            dataType: "json",
  ...
  $.dform.subscribe({
    ...
    options: function (options, type) {
      ...
      if (
        ...
        each(options, function (value, content) {
          var boxoptions =
            type === "radiobuttons" ? { type: "radio" } : { type: "checkbox" };
          if (typeof content === "string") {
...
(function ($) {
  ...
  $.dform.addType(
    ...
    function (options) {
      return $("<div>")
        .dform("attr", options)
        .progressbar(_getOptions("progressbar", options));
    },
  ...
  $.dform.addType(
    ...
    function (options) {
      return $("<div>")
        .dform("attr", options)
        .slider(_getOptions("slider", options));
    },
